...
def run_backtest_for_strategy(
    ...
    from phi.mft.store.memory_store import InMemoryBarStore
    from phi.mft.store.parquet_store import ParquetBarStore
    from phi.mft.validation.backtest_runner import make_synthetic_bars
    ...
    if strategy_id == "buy_and_hold":
        ...
        from phi.mft.assignment.engine import AssignmentEngine
...
def _get_strategy_signal(strategy_id: str, bt_df: pd.DataFrame, bar_store: Any, ticker: str, idx: int, params: dict[str, Any] | None = None) -> int:
    ...
    if strategy_id == "buy_and_hold":
        ...
        try:
            ...
            from phi.mft.engines.regime import RegimeEngine
            from phi.mft.engines.sentiment import SentimentEngine
            from phi.mft.mfm.merger import build_mfm
