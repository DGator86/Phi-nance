...
try:
    from lumibot_strategies._lumibot_lazy import Strategy, Asset, Order
    _LUMIBOT_OK = True
except ImportError:
    try:
...
from lumibot_strategies.prediction_tracker import PredictionMixin
...
class OptionsStrategy(PredictionMixin, Strategy):  # type: ignore[misc]
    ...
    def on_backtest_end(self) -> None:
        ...
        from lumibot_strategies.prediction_tracker import compute_prediction_accuracy
